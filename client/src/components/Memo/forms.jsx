                ...
                <form onSubmit={handleOnSubmit} >
                    <label className='flex gap-3'>
                        ...
                        <input
                            ...
                            placeholder='title . . .'
                            className='px-2 h-[3rem] border-[2px] border-white/20 w-[22.775rem]  mx-[10rem] sm:mx-0 sm:w-[33rem] focus:outline-none bg-transparent placeholder:opacity-70 text-white placeholder:text-gray-50 shadow-2xl backdrop-blur-3xl rounded-xl '
                        />
                    </label>
                    <textarea
                    ...
                    <label className="relative flex justify-center items-center">
                        ...
                        />
                        <button type='submit' className='text-white border-[2px] border-white/20 bg-transparent shadow-2xl ml-[0.5rem] backdrop-blur-3xl mt-2 p-3 px-[2rem] sm:px-[5rem] rounded-xl'>Submit</button>
                    </label>
                </form>
            </div>
        </div>
